...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/URLS_USA")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/xU_S_A1")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/BaBaNeyork/VedStream")
